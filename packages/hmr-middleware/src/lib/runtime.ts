 ...
 * HMR Runtime Module
 *
 * This is served at /@remix/hmr/runtime.js by the middleware.
...
export function generateRuntimeModule(): string {
  return `
// =============================================================================
// HMR Runtime Module (served by @remix-run/hmr-middleware)
// =============================================================================
...
export function __hmr_call(handle) {
...
// This simplifies HTML injection to just: <script type="module" src="/@remix/hmr/runtime.js">

(function connect() {
  const sseUrl = window.location.origin + '/@remix/hmr';
